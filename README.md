...
│
├── models/                        # Saved models
│   ├── best_model_week3.pkl
│   ├── neural_network_week2_improved.pkl
│   ├── scaler_X.pkl
│   ├── scaler_y.pkl
│   └── pca_model.pkl
│
...
│   │   ├── manifold_pca_analysis.png
│   │   └── manifold_tsne_analysis.png
│   ├── week2/
│   │   ├── week2_training_improved.png
│   │   └── week2_predictions.png
│   ├── week3/
│   │   └── week3_comprehensive_comparison.png
│   ├── baseline_metrics.json
│   ├── week2_metrics_improved.json
│   ├── week3_all_experiments.json
...
│   └── presentation.pdf
│
├── house_prices_raw.csv          # Raw dataset
...
💻 Usage
Quick Start
bash# Run all weeks sequentially
jupyter notebook
